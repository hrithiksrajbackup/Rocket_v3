          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-bold text-gray-900">Resume Rocket</span>
              </Link>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Create, edit, and manage your professional resumes with ATS-compatible templates.
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-3xl font-bold text-purple-600">
                {resumes.length > 0 
                  ? Math.round(resumes.reduce((acc, resume) => acc + (resume.atsScore || 0), 0) / resumes.length)
                  : 0
                }%
              </div>
            </CardContent>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="flex space-x-2">
                        <Link href={`/builder?resume=${resume.id}`} className="flex-1">
                          <Button variant="outline" size="sm" className="w-full">
                            <Edit className="h-4 w-4 mr-2" />
                            Edit
                          </Button>
                        </Link>
                        <Link href={`/preview?resume=${resume.id}`} className="flex-1">
                          <Button variant="outline" size="sm" className="w-full">
