...
//             ref={resumeRef}
//           >
//             <TemplateRenderer resumeData={resumeData} templateId={templateId} />
//           </div>
//         </div>
//       </div>
...
export function ResumePreview({ resumeData, templateId }: ResumePreviewProps) {
  ...
  const handleExport = async () => {
    // This will be handled by the EnhancedExportButton
  };
  ...
  return (
    <div className={cn(
      ...
      {/* Preview Toolbar - Only preview-specific controls */}
      <div className="flex items-center justify-between border-b p-4 bg-white/80 backdrop-blur-sm shadow-sm">
        <div className="flex items-center space-x-4">
          {/* Zoom Controls */}
          <div className="flex items-center space-x-3 bg-gray-100 rounded-xl p-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          {/* Export, Share, Settings - Only in preview toolbar */}
