...
export function ResumeHeader({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Prepare the resume data for the API
      const apiResumeData = {
        ...
        templateId: templateId, // Make sure templateId is included at root level
      };
      ...
      toast({
        title: "Save Failed",
        description: error instanceof Error ? error.message : "Failed to save your resume. Please try again.",
        variant: "destructive",
      });
    } finally {
      setIsSaving(false);
